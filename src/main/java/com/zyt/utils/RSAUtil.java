...
public class RSAUtil {
     ...
     * RSA最大解密密文大小
     */
    private static final int MAX_DECRYPT_BLOCK = 258;
    ...
    public static Map<String, Object> getGenKeyPair() {
        return genKeyPair;
    }

    public static void setGenKeyPair(Map<String, Object> genKeyPair) {
        RSAUtil.genKeyPair = genKeyPair;
    }
}
