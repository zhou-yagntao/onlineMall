...
public class SecurityResponseResultUtil {

    private Logger logger = LoggerFactory.getLogger(SecurityResponseResultUtil.class);
    /**
     * 私有化构造器
     */
    private SecurityResponseResultUtil(){}
