 ...
 * @Package: com.zyt.entity
 * @ClassName: OrderTaskDetail
 * @Author: zhou_yangtao@yeah.net
 * @Description: 订单库存信息实体类锁定
 * @Date: 17:02 2021/3/2
 * @Version: 1.0
 */
public class OrderTaskDetail {
    ...
    public OrderTaskDetail(Integer id, Integer prod_id, String prod_name, Integer prod_num, Integer task_id, Integer lock_stauts) {
        this.id = id;
