package com.zyt.entity.to.secondKill;
 ...
 * @Package: com.zyt.entity.to.secondKill
 * @ClassName: SecondKillProdDetailsRedisTo
 * @Author: zhou_yangtao@yeah.net
 * @Description: 参与秒杀的商品信息的详情信息
 * @Date: 16:53 2021/3/12
 * @Version: 1.0
 */
public class SecondKillProdDetailsRedisTo {
    ...
    //随机码
    private String prodRandomCode;

    //当前商品详细信息
    private ProductDetailsVo productDetailsVo;

    public SecondKillProdDetailsRedisTo() {
      super();
    }

    public SecondKillProdDetailsRedisTo(Integer relation_id, Integer promotion_session_id, Integer prod_id, Integer seckill_price, Integer seckill_count, Integer seckill_limit, Integer seckill_sort, Integer store_id, Long startTime, Long endTime, String prodRandomCode, ProductDetailsVo productDetailsVo) {
        ...
        this.prodRandomCode = prodRandomCode;
    ...
    public String getProdRandomCode() {
        return prodRandomCode;
    }

    public void setProdRandomCode(String prodRandomCode) {
        this.prodRandomCode = prodRandomCode;
    }
